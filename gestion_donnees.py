...
class GestionDonnees:
    ...
    def __init__(self, x_train, y_train, x_test,y_test,labels,classes,train_df,test_df):
    ...
    def stratifiedSelection(self):
        ...
        for train_index, test_index in split.split(self.train_df, self.labels):
            self.x_train, self.x_test = self.train_df.values[train_index], self.train_df.values[test_index]
